class MinHeap():
    ...
    def rearrangeDown(self, i):
        ...
        while i*2 <= self.size:
            ...
            if self.heapList[min_child] < self.heapList[i]:
    ...
    def rearrangeUp(self, i):
        # while it has parent
        while i//2 > 0:
            # ako je dijete manje od parenta, pomakni ga gore
    ...
    def minChild(self, i):
        ...
        if right > self.size:
            ...
            if min(self.heapList[left], self.heapList[right]) == self.heapList[left]:
                return left
            else:
                return right
